...
public class ChatCraftPluginBungee extends Plugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            this.getLogger().log(Level.INFO, "Successfully setup ChatCraftPluginBungee plugin.");
        } catch (IOException e) {
            this.getLogger().log(Level.SEVERE, "Error with config for ChatCraftPluginBungee plugin.");
            e.printStackTrace();
        }
    }
    ...
    public Conf loadConf(File file) throws IOException {
        try (Reader reader = new BufferedReader(new FileReader(file))) {
            return GSON_NON_PRETTY.fromJson(reader, Conf.class);
